(function() {
  ...
  _.memoize = function(func) {
    ...
    return function(...innerArg) {
      var stringArg = JSON.stringify(innerArg);
      if (!storage[stringArg]) {
        var result = func.apply(this, arguments);
        storage[JSON.stringify(innerArg)] = result;
      }
      console.log(storage);
      return storage[stringArg];
    };
  };
  ...
  _.shuffle = function(array) {
    ...
    for (var i = 0; i < array.length; i++) {
      ...
      var rand = randomize(len);
      result.push(arrCopy[rand]);
  ...
  _.zip = function() {
  //array.sort(function (a,b){return a.lenght-b.length}
    var output = [];
